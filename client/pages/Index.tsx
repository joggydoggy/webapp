      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 pt-20 pb-32 relative">
          <div className="max-w-4xl mx-auto text-center">
            <Badge
              variant="secondary"
              className="mb-6 bg-dogzilla-yellow/20 text-dogzilla-navy border-dogzilla-yellow/30"
            >
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Create custom clothing for your furry friend with our innovative
              design platform. From measurements to delivery, we make your dog
              look amazing.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Every detail designed with your dog's comfort and your style in
              mind
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="group hover:shadow-lg transition-all duration-300 border-dogzilla-purple/20">
              <CardHeader>
                ...
                <CardDescription>
                  Guided measurement process with videos and images to ensure
                  the perfect fit for your dog's unique body shape.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-dogzilla-orange/20">
              <CardHeader>
                ...
                <CardDescription>
                  See exactly how your design will look with our 3D prototype
                  viewer. Change colors, fabrics, and styles in real-time.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-dogzilla-yellow/20">
              <CardHeader>
                ...
                <CardDescription>
                  Choose from classic, modern, and sporty styles with premium
                  fabrics that are comfortable and durable.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-dogzilla-purple/20">
              <CardHeader>
                ...
                <CardDescription>
                  Standard, express, and tracked delivery options. Get your
                  custom clothing delivered right to your door.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-dogzilla-orange/20">
              <CardHeader>
                ...
                <CardDescription>
                  Multiple payment options including credit cards, PayPal, Apple
                  Pay, and Google Pay with bank-level security.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-dogzilla-yellow/20">
              <CardHeader>
                ...
                <CardDescription>
                  ...
                  Design on the go, anywhere, anytime.
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              From classic elegance to modern sporty looks, we have styles for
              every personality
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-dogzilla-purple/5 via-dogzilla-orange/5 to-dogzilla-yellow/5">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join thousands of pet parents who trust Dogzilla for custom dog
            clothing
          </p>
